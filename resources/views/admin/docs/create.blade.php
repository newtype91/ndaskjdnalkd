                ...
                <div class="row">
                    <div class="col-12">
                        <form action="{{route('admin.docs.store')}}" method="POST" enctype="multipart/form-data" >
                            ...
                            <div class="form-group w-25">
                                <label>Тип</label>
                                <input type="text" class="form-control" name="type" placeholder="Введите тип документа" value="{{old('type')}}">
                                @error('type')
                                <div class="text-danger">Заполните это поле</div>
                                @enderror
                            </div>
                            <div class="form-group w-25">
                                ...
                                <input type="text" class="form-control" name="date" placeholder="Введите дату принятия в формате 01.01.2021" value="{{old('date')}}">
                                @error('date')
                                <div class="text-danger">Заполните это поле</div>
                                @enderror
                            </div>
